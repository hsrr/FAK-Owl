...
from model.openllama_multicls_only import OpenLLAMAPEFTModelMultiClsOnly


parser = argparse.ArgumentParser("FKA_Owl_MultiCls_Only", add_help=True)
parser.add_argument("--FKA_Owl_ckpt_path", default="./ckpt/train_DGM4_multicls_only/pytorch_model.pt")
...
model = OpenLLAMAPEFTModelMultiClsOnly(**args)
...
print("[!] init the multiclass-only model over ...")
